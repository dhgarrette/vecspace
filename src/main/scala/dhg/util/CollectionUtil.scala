...
object CollectionUtil {
  ...
  implicit def toEnriched_toTuple_Seq[A](seq: Seq[A]) = new Enriched_toTuple_Seq(seq)
  class Enriched_toTuple_Seq[A](val seq: Seq[A]) {
  ...
  implicit def toEnriched_toTuple_Array[A](seq: Array[A]) = new Enriched_toTuple_Array[A](seq)
  class Enriched_toTuple_Array[A](val seq: Array[A]) {
  ...
  implicit def toEnriched_prependAppend_Iterator[A](self: Iterator[A]) = new Enriched_prependAppend_Iterator[A](self)
  class Enriched_prependAppend_Iterator[A](val self: Iterator[A]) { // {
    /**
  ...
  implicit def toEnriched_counts_TraversableOnce[A](self: TraversableOnce[A]) = new Enriched_counts_TraversableOnce[A](self)
  class Enriched_counts_TraversableOnce[A](val self: TraversableOnce[A]) {
    /**
     * Map each distinct item in the collection to the number of times it appears.
     *
  ...
  implicit def toEnriched_groupBy_Iterator[A](self: Iterator[A]) = new Enriched_groupBy_Iterator[A](self)
  class Enriched_groupBy_Iterator[A](val self: Iterator[A]) {
    /**
  ...
  implicit def toEnriched_groupByKey_Traversable[K, V, Repr](self: TraversableLike[(K, V), Repr]) = new Enriched_groupByKey_Traversable[K, V, Repr](self)
  class Enriched_groupByKey_Traversable[K, V, Repr](val self: TraversableLike[(K, V), Repr]) {
    /**
     * For a collection of pairs (k,v), create a map from each `k` to the
     * collection of `v`s with which it is associated.
     *
    ...
    def groupByKey[That](implicit bf: CanBuildFrom[Repr, V, That]): Map[K, That] = {
      ...
      for ((key, value) <- self.asInstanceOf[Traversable[(K, V)]]) {
  ...
  implicit def toEnriched_groupByKey_Iterator[A](self: Iterator[A]) = new Enriched_groupByKey_Iterator[A](self)
  class Enriched_groupByKey_Iterator[A](val self: Iterator[A]) {
    /**
  ...
  implicit def toEnriched_ungroup_GenTraversableOnce[A, B](self: GenTraversableOnce[(A, GenTraversableOnce[B])]) = new Enriched_ungroup_GenTraversableOnce[A, B](self)
  class Enriched_ungroup_GenTraversableOnce[A, B](val self: GenTraversableOnce[(A, GenTraversableOnce[B])]) {
    /**
     * For a map with collections for values, return an iterator of pairs
     * where each key is paired with each item in its value collection.
     *
  ...
  implicit def toEnriched_dropRightWhile_Seq[A, Repr](self: SeqLike[A, Repr]) = new Enriched_dropRightWhile_Seq[A, Repr](self)
  class Enriched_dropRightWhile_Seq[A, Repr](val self: SeqLike[A, Repr]) {
  ...
  // TODO:
  //  implicit def toEnriched_dropRightWhile_String(self: String) = new Enriched_dropRightWhile_String(self)
  //  class Enriched_dropRightWhile_String(val self: String) {
  ...
  implicit def toEnriched_splitAt_Iterator[A](self: Iterator[A]) = new Enriched_splitAt_Iterator[A](self)
  class Enriched_splitAt_Iterator[A](val self: Iterator[A]) { // {
    /**
  ...
  implicit def toEnriched_splitWhere_Iterator[A](self: Iterator[A]) = new Enriched_splitWhere_Iterator[A](self)
  class Enriched_splitWhere_Iterator[A](val self: Iterator[A]) { // {
    /**
     * Split this on items for which the predicate is true.
     *
  ...
  class BuilderHolder[A, That](builder: => Builder[A, That]) {
    ...
    override def toString() = "BuilderHolder(%s, isEmpty=%s)".format(b.result, isEmpty)
  }

  implicit def toEnriched_splitWhere_Traversable[A, Repr](self: TraversableLike[A, Repr]) = new Enriched_splitWhere_Traversable[A, Repr](self)
  class Enriched_splitWhere_Traversable[A, Repr](val self: TraversableLike[A, Repr]) {
    /**
  ...
  implicit def toEnriched_split_Iterator[A](self: Iterator[A]) = new Enriched_split_Iterator[A](self)
  class Enriched_split_Iterator[A](val self: Iterator[A]) {
    /**
     * Split this collection on each occurrence of the delimiter.
     *
     * Inspired by String.split
  ...
  implicit def toEnriched_split_Traversable[A, Repr](self: TraversableLike[A, Repr]) = new Enriched_split_Traversable[A, Repr](self)
  class Enriched_split_Traversable[A, Repr](val self: TraversableLike[A, Repr]) {
    /**
     * Split this collection on each occurrence of the delimiter.
     *
     * Inspired by String.split
  ...
  implicit def toEnriched_zipSafe_Iterator[A](self: Iterator[A]) = new Enriched_zipSafe_Iterator[A](self)
  class Enriched_zipSafe_Iterator[A](val self: Iterator[A]) { // {
    /**
  ...
  implicit def toEnriched_zipSafe_GenTraversable[A, Repr](self: GenTraversableLike[A, Repr]) = new Enriched_zipSafe_GenTraversable[A, Repr](self)
  class Enriched_zipSafe_GenTraversable[A, Repr](val self: GenTraversableLike[A, Repr]) {
    /**
     * zip this collection with another, throwing an exception if they
     * are not of equal length.
     *
  ...
  implicit def toEnriched_zipSafe_Tuple_of_Iterator[A, B](self: (Iterator[A], GenTraversableOnce[B])) = new Enriched_zipSafe_Tuple_of_Iterator[A, B](self)
  class Enriched_zipSafe_Tuple_of_Iterator[A, B](val self: (Iterator[A], GenTraversableOnce[B])) {
    /**
     * zip this collection with another, throwing an exception if they
     * are not of equal length.
     *
  ...
  implicit def toEnriched_zipSafe_Tuple_of_GenTraversable[A, Repr, B](self: (GenTraversableLike[A, Repr], GenTraversableOnce[B])) = new Enriched_zipSafe_Tuple_of_GenTraversable[A, Repr, B](self)
  class Enriched_zipSafe_Tuple_of_GenTraversable[A, Repr, B](val self: (GenTraversableLike[A, Repr], GenTraversableOnce[B])) {
    /**
     * zip this collection with another, throwing an exception if they
     * are not of equal length.
     *
  ...
  implicit def toEnriched_unzip_Iterator[T, U](self: Iterator[(T, U)]) = new Enriched_unzip_Iterator[T, U](self)
  class Enriched_unzip_Iterator[T, U](val self: Iterator[(T, U)]) {
  ...
  implicit def toEnriched_mapTo_GenTraversableLike[A, Repr](self: GenTraversableLike[A, Repr]) = new Enriched_mapTo_GenTraversableLike[A, Repr](self)
  class Enriched_mapTo_GenTraversableLike[A, Repr](val self: GenTraversableLike[A, Repr]) {
    /**
     * Map a function over the collection, returning a set of pairs consisting
     * of the original item and the result of the function application
     *
  ...
  implicit def toEnriched_mapTo_Iterator[A](self: Iterator[A]) = new Enriched_mapTo_Iterator[A](self)
  class Enriched_mapTo_Iterator[A](val self: Iterator[A]) { // {
    /**
     * Map a function over the collection, returning a set of pairs consisting
     * of the original item and the result of the function application
     *
  ...
  implicit def toEnriched_mapToVal_GenTraversableLike[A, Repr](self: GenTraversableLike[A, Repr]) = new Enriched_mapToVal_GenTraversableLike[A, Repr](self)
  class Enriched_mapToVal_GenTraversableLike[A, Repr](val self: GenTraversableLike[A, Repr]) {
    /**
     * Map each item in the collection to a particular value
     *
  ...
  implicit def toEnriched_mapToVal_Iterator[A](self: Iterator[A]) = new Enriched_mapToVal_Iterator[A](self)
  class Enriched_mapToVal_Iterator[A](val self: Iterator[A]) { // {
    /**
     * Map each item in the collection to a particular value
     *
     * Functionally equivalent to: map(x => x -> v)
  ...
  implicit def toEnriched_mapKeys_GenTraversable[T, U, Repr](self: GenTraversableLike[(T, U), Repr]) = new Enriched_mapKeys_GenTraversable[T, U, Repr](self)
  class Enriched_mapKeys_GenTraversable[T, U, Repr](val self: GenTraversableLike[(T, U), Repr]) {
    /**
  ...
  implicit def toEnriched_mapKeys_Iterator[T, U](self: Iterator[(T, U)]) = new Enriched_mapKeys_Iterator[T, U](self)
  class Enriched_mapKeys_Iterator[T, U](val self: Iterator[(T, U)]) { // {
    /**
     * In a collection of pairs, map a function over the first item of each
     * pair.
     *
  ...
  implicit def toEnriched_mapVals_GenTraversable[T, U, Repr](self: GenTraversableLike[(T, U), Repr]): Enriched_mapVals_GenTraversable[T, U, Repr] = new Enriched_mapVals_GenTraversable[T, U, Repr](self)
  class Enriched_mapVals_GenTraversable[T, U, Repr](val self: GenTraversableLike[(T, U), Repr]) {
    /**
  ...
  implicit def toEnriched_mapVals_Iterator[T, U](self: Iterator[(T, U)]): Enriched_mapVals_Iterator[T, U] = new Enriched_mapVals_Iterator[T, U](self)
  class Enriched_mapVals_Iterator[T, U](val self: Iterator[(T, U)]) { // {
    /**
     * In a collection of pairs, map a function over the second item of each
     * pair.
     *
  ...
  implicit def toEnriched_submap_GenTraversable[T, TRepr, SRepr](self: GenTraversableLike[GenTraversableLike[T, TRepr], SRepr]) = new Enriched_submap_GenTraversable[T, TRepr, SRepr](self)
  class Enriched_submap_GenTraversable[T, TRepr, SRepr](val self: GenTraversableLike[GenTraversableLike[T, TRepr], SRepr]) {
    /**
     * In a collection of collections, map a function over the inner collections without flattening.
     *
  ...
  implicit def toEnriched_submap_Iterator[T, Repr](self: Iterator[GenTraversableLike[T, Repr]]) = new Enriched_submap_Iterator[T, Repr](self)
  class Enriched_submap_Iterator[T, Repr](val self: Iterator[GenTraversableLike[T, Repr]]) { // {
    /**
     * In a collection of collections, map a function over the inner collections without flattening.
     *
     * @param f	function to map over the inner collections
  ...
  implicit def toEnriched_mapt_2_GenTraversableLike[A, B, Repr](self: GenTraversableLike[(A, B), Repr]) = new Enriched_mapt_2_GenTraversableLike[A, B, Repr](self)
  class Enriched_mapt_2_GenTraversableLike[A, B, Repr](val self: GenTraversableLike[(A, B), Repr]) {
    def mapt[R, That](f: (A, B) => R)(implicit bf: CanBuildFrom[Repr, R, That]) = {
      self.map(x => f(x._1, x._2))
    }
  }

  implicit def toEnriched_mapt_2_Iterator[A, B](self: Iterator[(A, B)]) = new Enriched_mapt_2_Iterator[A, B](self)
  class Enriched_mapt_2_Iterator[A, B](val self: Iterator[(A, B)]) { // {
  ...
  implicit def toEnriched_mapt_3_GenTraversableLike[A, B, C, Repr](self: GenTraversableLike[(A, B, C), Repr]) = new Enriched_mapt_3_GenTraversableLike[A, B, C, Repr](self)
  class Enriched_mapt_3_GenTraversableLike[A, B, C, Repr](val self: GenTraversableLike[(A, B, C), Repr]) {
    def mapt[R, That](f: (A, B, C) => R)(implicit bf: CanBuildFrom[Repr, R, That]) = {
      self.map(x => f(x._1, x._2, x._3))
    }
  }

  implicit def toEnriched_mapt_3_Iterator[A, B, C](self: Iterator[(A, B, C)]) = new Enriched_mapt_3_Iterator[A, B, C](self)
  class Enriched_mapt_3_Iterator[A, B, C](val self: Iterator[(A, B, C)]) { // {
  ...
  implicit def toEnriched_foldLeftWhile_GenTraversableOnce[A](self: GenTraversableOnce[A]) = new Enriched_foldLeftWhile_GenTraversableOnce[A](self)
  class Enriched_foldLeftWhile_GenTraversableOnce[A](val self: GenTraversableOnce[A]) {
  ...
  implicit def toEnrich_avg_GenTraversableOnce[A](self: GenTraversableOnce[A])(implicit num: Fractional[A]) = new Enrich_avg_GenTraversableOnce[A](self: GenTraversableOnce[A])(num)
  class Enrich_avg_GenTraversableOnce[A](val self: GenTraversableOnce[A])(implicit num: Fractional[A]) {
    /**
     * Find the average (mean) of this collection of numbers.
     *
  ...
  implicit def toEnrich_avg_Int_GenTraversableOnce(self: GenTraversableOnce[Int]) = new Enrich_avg_Int_GenTraversableOnce(self)
  class Enrich_avg_Int_GenTraversableOnce(val self: GenTraversableOnce[Int]) {
    /**
     * Find the average (mean) of this collection of numbers.
     *
     * @return the average (mean)
  ...
  implicit def toEnriched_normalize_GenTraversable[A, Repr](self: GenTraversableLike[A, Repr]) = new Enriched_normalize_GenTraversable[A, Repr](self)
  class Enriched_normalize_GenTraversable[A, Repr](val self: GenTraversableLike[A, Repr]) {
    /**
     * Normalize this collection of numbers by dividing each by the sum
     *
  ...
  implicit def toEnriched_normalize_Int_GenTraversable[Repr](self: GenTraversableLike[Int, Repr]) = new Enriched_normalize_Int_GenTraversable[Repr](self)
  class Enriched_normalize_Int_GenTraversable[Repr](val self: GenTraversableLike[Int, Repr]) {
    /**
     * Normalize this collection of numbers by dividing each by the sum
     *
     * @return normalized values
  ...
  implicit def toEnriched_normalizeValues_GenTraversable[T, U, Repr](self: GenTraversableLike[(T, U), Repr]) = new Enriched_normalizeValues_GenTraversable[T, U, Repr](self)
  class Enriched_normalizeValues_GenTraversable[T, U, Repr](val self: GenTraversableLike[(T, U), Repr]) {
    /**
     * Normalize this values in this collection of pairs
     *
     * @return a collection of pairs
  ...
  implicit def toEnriched_normalizeValues_Int_GenTraversable[T, Repr](self: GenTraversableLike[(T, Int), Repr]) = new Enriched_normalizeValues_Int_GenTraversable[T, Repr](self)
  class Enriched_normalizeValues_Int_GenTraversable[T, Repr](val self: GenTraversableLike[(T, Int), Repr]) {
    /**
     * Normalize this values in this collection of pairs
     *
     * @return a collection of pairs
  ...
  implicit def toEnriched_maxByN_GenTraversable[A, Repr](self: GenTraversableLike[A, Repr]) = new Enriched_maxByN_GenTraversable[A, Repr](self)
  class Enriched_maxByN_GenTraversable[A, Repr](val self: GenTraversableLike[A, Repr]) {
    /**
  ...
  implicit def toEnriched_maxByN_Iterator[A](self: Iterator[A]) = new Enriched_maxByN_Iterator[A](self)
  class Enriched_maxByN_Iterator[A](val self: Iterator[A]) {
    /**
     * Find the N maximum entries in the collection.
     *
     * @return a collection containing the N maximum entries, sorted so the max is first
  ...
  implicit def toEnriched_minByN_GenTraversable[A, Repr](self: GenTraversableLike[A, Repr]) = new Enriched_minByN_GenTraversable[A, Repr](self)
  class Enriched_minByN_GenTraversable[A, Repr](val self: GenTraversableLike[A, Repr]) {
    /**
  ...
  implicit def toEnriched_minByN_Iterator[A](self: Iterator[A]) = new Enriched_minByN_Iterator[A](self)
  class Enriched_minByN_Iterator[A](val self: Iterator[A]) {
    /**
     * Find the N minimum entries in the collection.
     *
     * @return a collection containing the N minimum entries, sorted so the min is first
  ...
  // TODO:
  //implicit def toEnriched_shuffle_Seq[A, Repr](self: SeqLike[A, Repr]) = new Enriched_shuffle_Seq[A, Repr](self)
  //class Enriched_shuffle_Seq[A, Repr](val self: SeqLike[A, Repr]) {
  //    def shuffle[That](implicit bf: CanBuildFrom[Repr, A, That]): That =
  //      (bf(self.asInstanceOf[Repr]) ++= Random.shuffle(self)).result
  //  }
  //
  //implicit def toEnriched_shuffle_Iterator[A](self: Iterator[A]) = new Enriched_shuffle_Iterator[A](self)
  //class Enriched_shuffle_Iterator[A](val self: Iterator[A]) {
  ...
  implicit def toEnriched_toBitSet_GenTraversableOnce(self: GenTraversableOnce[Int]) = new Enriched_toBitSet_GenTraversableOnce(self)
  class Enriched_toBitSet_GenTraversableOnce(val self: GenTraversableOnce[Int]) {
    def toBitSet: BitSet = BitSet() ++ self
  }

  implicit def toEnrichedWithToVector[T](self: GenTraversableOnce[T]) = new EnrichedWithToVector(self)
  implicit def toEnrichedArrayWithToVector[T](self: Array[T]) = new EnrichedWithToVector(self)
  class EnrichedWithToVector[T](val self: GenTraversableOnce[T]) {
    def toVector: Vector[T] = Vector() ++ self
  }
}
